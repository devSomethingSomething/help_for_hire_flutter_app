  ...
  Widget build(BuildContext context) {
    return Consumer2<WorkerService,LocationService>(builder: (context,workerService,locationService,child){
      context.read<WorkerService>().getWorkersInCity(
          locationId: workerService.currentUser!.locationId);
      return Scaffold(
        appBar: AppBar(
          title: Text('Profile'),
          ...
          child: Column(
            children: [
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      '${workerService.currentUser!.name} ${workerService.currentUser!.surname}',
                      style: TextStyle(
                        fontSize: 25,
              ...
              textWidget(
                  ...
                  '${workerService.currentUser!.name}'),
              textWidget(
                  TextButton.icon(
                      onPressed: () {},
                      icon: Icon(Icons.edit),
                  ...
                  '${workerService.currentUser!.surname}'),
              textWidget(
                  TextButton.icon(
                      onPressed: () {},
                      icon: Icon(Icons.edit),
              ...
              textWidget(
                  ...
                  '${workerService.currentUser!.phoneNumber}'),
              textWidget(
                  TextButton.icon(
                      onPressed: () {},
                      icon: Icon(Icons.edit),
                  ...
                  'R ${workerService.currentUser!.minimumFee}'),
              textWidget(
                  TextButton.icon(
                      onPressed: () {},
                      icon: Icon(Icons.edit),
                  ...
                  '${Jobs().JobsToString(workerService.currentUser!.jobIds)}'),
              /*textWidget(
                  TextButton.icon(
                      onPressed: () {},
                      icon: Icon(Icons.edit),
